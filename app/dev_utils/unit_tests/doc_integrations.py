...
# URLs for testing
GOOGLE_SHEET_URL = "https://docs.google.com/spreadsheets/d/1EZ8dMacJAPpVyKJrSOTQ3CG8mx1JhyWC-i0h9qurZNs/edit?gid=55185115#gid=55185115"
GOOGLE_SHEET_NAME = "Practice Test"
...
@pytest.mark.asyncio
async def test_google_sheets_append_to_new_sheet(g_integration):


    # Attempt to append the same data
    await g_integration.append_to_new_google_sheet(TEST_DF, GOOGLE_SHEET_URL, GOOGLE_SHEET_NAME)
